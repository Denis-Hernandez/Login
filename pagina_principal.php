...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    addUser($nombre_usuario,$user,$password);
}

function addUser($nombre_usuario,$user,$contra){
    ...
    $sql = "INSERT INTO usuarios(nombre_usuario,usuario,password) VALUES('$nombre_usuario','$user','$contra')";
		...
		<!-- Scripts -->
            ...
            <script>
                function cerrarSesion(){
                    ...
                    xhr.open('GET', 'finalizar_sesion.php', true);
                    xhr.send();
                    
                    // Redireccionar a otra página después de finalizar la sesión
